...
| A "blast radius" was measured at the wrong depth | Diffing the TOP THREE results of a 79-query ranking corpus missed three degradations sitting at ranks 2-10, and the author reported two of them as improvements. The snapshot holds ten; read all ten. A change that fixes rank 1 and destroys ranks 4-10 is not an improvement, and a top-N diff with N smaller than the page an agent sees cannot tell you which happened |
