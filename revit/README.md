...
`Update available` (the MCP Server checks GitHub for releases; Revit closes to apply an add-in
change, reopen it afterwards). Uninstall from Windows **Apps & features** or with
