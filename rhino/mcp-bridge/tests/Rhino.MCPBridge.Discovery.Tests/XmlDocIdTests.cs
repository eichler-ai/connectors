...
public class XmlDocIdTests
{
    ...
    {
        Assert.Equal("T:Rhino.MCPBridge.Discovery.Tests.Fixtures.Widget", XmlDocId.GetDocId(typeof(Widget)));
    }
    ...
    public void NoArgConstructor_ProducesCtorWithNoParens()
    {
        ...
        Assert.Equal("M:Rhino.MCPBridge.Discovery.Tests.Fixtures.Widget.#ctor", XmlDocId.GetDocId(ctor));
    }
    ...
    public void OneArgConstructor_ProducesCtorWithParen()
    {
        ...
        Assert.Equal("M:Rhino.MCPBridge.Discovery.Tests.Fixtures.Widget.#ctor(System.Int32)", XmlDocId.GetDocId(ctor));
    }
    ...
    public void NoArgMethod_HasNoParens()
    {
        ...
        Assert.Equal("M:Rhino.MCPBridge.Discovery.Tests.Fixtures.Widget.Describe", XmlDocId.GetDocId(method));
    }
    ...
    public void OneArgMethod_HasOneParamType()
    {
        ...
        Assert.Equal("M:Rhino.MCPBridge.Discovery.Tests.Fixtures.Widget.Describe(System.Int32)", XmlDocId.GetDocId(method));
    }
    ...
    public void GenericCollectionParam_UsesCurlyBraceArgsWithoutArity()
    {
        ...
        Assert.Equal(
            "M:Rhino.MCPBridge.Discovery.Tests.Fixtures.Widget.AddTags(System.Collections.Generic.ICollection{System.Int32})",
    ...
    public void GenericCollectionReturnType_DoesNotAffectDocId()
    {
        ...
        Assert.Equal("M:Rhino.MCPBridge.Discovery.Tests.Fixtures.Widget.GetTags", XmlDocId.GetDocId(method));
    }
    ...
    public void Property_UsesPPrefix()
    {
        ...
        Assert.Equal("P:Rhino.MCPBridge.Discovery.Tests.Fixtures.Widget.Id", XmlDocId.GetDocId(property));
    }
    ...
    public void Indexer_IncludesIndexParameterTypes()
    {
        ...
        Assert.Equal("P:Rhino.MCPBridge.Discovery.Tests.Fixtures.Gadget.Slot(System.Int32)", XmlDocId.GetDocId(indexer));
    }
    ...
    public void Field_UsesFPrefix()
    {
        ...
        Assert.Equal("F:Rhino.MCPBridge.Discovery.Tests.Fixtures.Widget.Name", XmlDocId.GetDocId(field));
    }
    ...
    public void Event_UsesEPrefix()
    {
        ...
        Assert.Equal("E:Rhino.MCPBridge.Discovery.Tests.Fixtures.Widget.Changed", XmlDocId.GetDocId(evt));
    }
    ...
    public void StaticMethod_SameFormatAsInstanceMethod()
    {
        ...
        Assert.Equal("M:Rhino.MCPBridge.Discovery.Tests.Fixtures.Widget.Create", XmlDocId.GetDocId(method));
    }
}
