...
/// (Rhino.MCPBridge.Discovery.Tests.xml, next to this assembly's own DLL; see the csproj's
...
public class DiscoveryServiceTests
{
    ...
    private const string OtherNamespace = "Rhino.MCPBridge.Discovery.Tests.Fixtures.Other";
    ...
    // all, rather than an empty discovery surface) is covered by Rhino.MCPBridge.Core.Tests' DiscoveryDispatchTests:
    ...
    public void DescribeFunction_SingleOverload_ReturnsFullDocShape()
    {
        ...
        var result = service.DescribeFunction("Rhino.MCPBridge.Discovery.Tests.Fixtures.Gadget.Run", memberId: null);
    ...
    public void DescribeFunction_MultipleOverloads_NoDisambiguation_ReturnsCompactList()
    {
        ...
        var result = service.DescribeFunction("Rhino.MCPBridge.Discovery.Tests.Fixtures.Widget.Describe", memberId: null);

        Assert.Null(result.Single);
        Assert.NotNull(result.Overloads);
        Assert.Equal("Rhino.MCPBridge.Discovery.Tests.Fixtures.Widget.Describe", result.Overloads!.Member);
    ...
    public void DescribeFunction_UnknownMember_ThrowsNotFound()
    {
        ...
        Assert.Throws<DiscoveryMemberNotFoundException>(() =>
            service.DescribeFunction("Rhino.MCPBridge.Discovery.Tests.Fixtures.Widget.NoSuchMethod", null));
    }
    ...
    public void DescribeFunction_UnknownType_ThrowsNotFound()
    {
        ...
        Assert.Throws<DiscoveryMemberNotFoundException>(() =>
            service.DescribeFunction("Rhino.MCPBridge.Discovery.Tests.Fixtures.NoSuchType.Foo", null));
    }
    ...
    public void DescribeFunction_Constructor_ResolvesViaCtorKeyword()
    {
        ...
        var result = service.DescribeFunction("Rhino.MCPBridge.Discovery.Tests.Fixtures.Widget.ctor", memberId: null);
