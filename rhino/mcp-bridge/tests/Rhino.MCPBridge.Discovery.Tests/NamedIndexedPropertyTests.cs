...
using Rhino.MCPBridge.Discovery.Fixtures.VB;
using Xunit;
...
{
    private const string Fixture = "Rhino.MCPBridge.Discovery.Fixtures.VB.NamedIndexedFixture";
    ...
    public void CSharpIndexerWithACustomIndexerName_IsStillTheDefaultMember()
    {
        ...
        var result = service.DescribeFunction("Rhino.MCPBridge.Discovery.Tests.Fixtures.Gadget.Slot", memberId: null);
    ...
    public void ListFunctions_NamedIndexedProperty_IsListedUnderItsPropertyName()
    {
        ...
        var result = service.ListFunctions(namespaceFilter: "Rhino.MCPBridge.Discovery.Fixtures.VB", typeFilter: "NamedIndexedFixture", cursor: null, pageSize: 50);
